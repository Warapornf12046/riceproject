...
<body>
    ...
    <div> <center>
            ...
            <input class="btn1" type="button" onclick="document.location='sumservice.php'" value="สรุปรายการ">
            <input class="btn1" type="button" onclick="document.location='member2.php'" value="ถัดไป">
    </div></center>
